    ...
    if (false && categories.length === 0) {
        categories = [
            ...
            { 
                ...
                parentId: null,
                questions: [
                    { id: 1, text: "Azərbaycan Respublikası Konstitusiyasına əlavələr Azərbaycan Respublikasının Milli Məclisində neçə səs çoxluğu ilə Konstitusiya qanunları şəklində qəbul edilir?", options: ["83", "95", "63", "125", "81"], correctIndex: 1 },
                    { id: 2, text: "Azərbaycan Respublikasının Konstitusiyasının 15-ci maddəsinin birinci hissəsinə əsasən Azərbaycan Respublikasında iqtisadiyyatın inkişafı müxtəlif mülkiyyət növlərinə əsaslanaraq nəyə xidmət edir?", options: ["Bütün cəmiyyətin və hər kəsin firavanlığının və sosial müdafiəsinin təmin edilməsinə", "İnsan və vətəndaş hüquq və azadlıqlarının mühafizə edilməsinə", "Sosial ədalətin, azadlığın və təhlükəsizliyin bərqərar edilməsinə", "Bazar münasibətləri əsasında iqtisadiyyatın və azad sahibkarlığın inkişafına", "Xalqın rifahının yüksəldilməsinə"], correctIndex: 4 },
                    { id: 3, text: "Azərbaycan Respublikasının Konstitusiyasına əsasən müqəddəs hesab edilir:", options: ["Dövlət rəmzlərinə hörmət", "Vətəni müdafiə", "Vətənə sədaqət", "Ətraf mühitin qorunması", "Tarix və mədəniyyət abidələrinin qorunması"], correctIndex: 2 },
                    { id: 4, text: "Azərbaycan Respublikasının Konstitusiyasına görə məhkəmənin qəbul etdiyi qərarlar hansı subyektin adından çıxarılır?", options: ["Xalqın adından", "Qərarı qəbul etmiş məhkəmənin adından", "Millətin adından", "Dövlətin adından", "Azərbaycan Respublikasının Prezidenti adından"], correctIndex: 3 },
                    { id: 5, text: "Azərbaycan Respublikasının Konstitusiyasında məhkəmə hakimiyyətini həyata keçirən məhkəmələrdən hansının adı çəkilmir?", options: ["Azərbaycan Respublikasının Konstitusiya Məhkəməsi", "Azərbaycan Respublikasının Ali Məhkəməsi", "Azərbaycan Respublikasının apellyasiya məhkəmələri", "Naxçıvan Muxtar Respublikasının Ali Məhkəməsi", "Sadalanan məhkəmələrin hamısının adı çəkilir"], correctIndex: 4 },
                    { id: 6, text: "Azərbaycan Respublikasının Konstitusiyasında nəzərdə tutulan müddəalarla bağlı söylənilən fikirlərdən hansı yanlışdır?", options: ["Əcnəbilər və vətəndaşlığı olmayan şəxslər dövlət qulluğuna qanunla müəyyən edilməşdirilmiş qaydada qəbul edilə bilər", "Dini etiqad və əqidə hüquq pozuntusuna bəraət qazandırır", "Qanunu bilməmək məsuliyyətdən azad etmir", "Cinayətin törədilməsində təqsirləndirilən şəxs özünün təqsirsizliyini sübuta yetirməyə borclu deyildir", "Normativ hüquqi aktlar hüquqa və haqq-ədalətə əsaslanmalıdır"], correctIndex: 1 },
                    { id: 7, text: "Azərbaycan Respublikasının Konstitusiyasına görə qanunvericilik təşəbbüsü hüququna malik deyil:", options: ["Azərbaycan Respublikasının Baş naziri", "Azərbaycan Respublikasının Prezidenti", "Azərbaycan Respublikasının Ali Məhkəməsi", "Azərbaycan Respublikasının Prokurorluğu", "Naxçıvan Muxtar Respublikasının Ali Məclisi"], correctIndex: 0 },
                    { id: 8, text: "Azərbaycan Respublikası Prezidentinin səlahiyyətlərinə daxildir: 1. İnzibati ərazi bölgüsü; 2. AR Nazirlər Kabinetinin istefası haqqında qərar qəbul etmək; 3. Siyasi sığınacaq verilməsi məsələsini həll etmək; 4. Dövlətlərarası müqavilələri təsdiq və ləğv etmək; 5. Vətəndaşlıq məsələlərini həll etmək.", options: ["1-2-4", "2-3-4", "2-3-5", "3-4-5", "1-2-5"], correctIndex: 2 },
                    { id: 9, text: "Mülkiyyətin hansı növünə üstünlük verilir?", options: ["Dövlət mülkiyyətinə", "Xüsusi mülkiyyətə", "Bələdiyyə mülkiyyətinə", "Xüsusi və bələdiyyə mülkiyyətinə", "Mülkiyyətin heç bir növünə üstünlük verilmir"], correctIndex: 4 },
                    { id: 10, text: "Azərbaycan Respublikasında məhkəmə hakimiyyətinin müstəqilliyinin təminatçısı hansı orqan və ya vəzifəli şəxs hesab olunur?", options: ["AR Konstitusiya Məhkəməsi", "Azərbaycan Respublikasının Prezidenti", "Azərbaycan Respublikasının Ali Məhkəməsi", "Azərbaycan Respublikasının Milli Məclisi", "Azərbaycan xalqı"], correctIndex: 1 },
                    { id: 11, text: "Azərbaycan Respublikasının Konstitusiya Məhkəməsi neçə hakimdən ibarətdir?", options: ["7 hakim", "11 hakim", "15 hakim", "9 hakim", "12 hakim"], correct: 3 },
                    { id: 12, text: "Dövlət dilinin statusu Azərbaycan Respublikası Konstitusiyasının neçənci maddəsi ilə tənzimlənir?", options: ["19-cu maddə", "20-ci maddə", "21-ci maddə", "22-ci maddə", "23-cü maddə"], correct: 2 },
                    { id: 13, text: "Azərbaycan Respublikasının Silahlı Qüvvələrinin Ali Baş Komandanı kimdir?", options: ["Müdafiə Naziri", "Baş Nazir", "Milli Məclisin Sədri", "Azərbaycan Respublikasının Prezidenti", "Daxili İşlər Naziri"], correct: 3 },
                    { id: 14, text: "Azərbaycan Respublikasının Milli Məclisi neçə deputatdan ibarətdir?", options: ["100 deputat", "120 deputat", "125 deputat", "150 deputat", "85 deputat"], correct: 2 },
                    { id: 15, text: "Azərbaycan Respublikasının dövlət rəmzləri hansılardır?", options: ["Yalnız bayraq və gerb", "Yalnız bayraq və himn", "Bayraq, gerb və himn", "Yalnız gerb və himn", "Bayraq ve Konstitusiya"], correct: 2 },
                    { id: 16, text: "Azərbaycan Respublikasında dövlət hakimiyyətinin yeganə mənbəyi kimdir?", options: ["Dövlət orqanları", "Prezident", "Milli Məclis", "Azərbaycan xalqı", "Məhkəmələr"], correct: 3 },
                    { id: 17, text: "AR Konstitusiyasına görə kimin Azərbaycan Respublikası vətəndaşlığından məhrum edilməsi qadağandır?", options: ["Heç bir vətəndaş vətəndaşlıqdan məhrum edilə bilməz", "Yalnız xaricdə yaşayanların", "Yalnız cinayət törədənlərin", "Yalnız dövlət qulluqçularının", "Yalnız hərbi vəzifəlilərin"], correct: 0 },
                    { id: 18, text: "Azərbaycan Respublikasında din dövlətdən ayrıdırmı?", options: ["Xeyr, din dövlətlə birdir", "Bəli, din dövlətdən ayrıdır", "Yalnız bəzi dinlər ayrıdır", "Qanunla müəyyən edilməyib", "Yalnız paytaxtda ayrıdır"], correct: 1 },
                    { id: 19, text: "AR Konstitusiyasına görə AR Prezidenti neçə il müddətinə seçilir?", options: ["5 il", "6 il", "7 il", "4 il", "10 il"], correct: 2 },
                    { id: 20, text: "Azərbaycan Respublikasında dövlət hakimiyyətinin mənbəyi kimdir?", options: ["Prezident", "Xalq", "Baş nazir", "Dövlət"], correct: 1 },
                    { id: 21, text: "Azərbaycan xalqı kimlərdən ibarətdir?", options: ["AR ərazisində yaşayan əcnəbilərdən", "AR kənarda yaşayan vətəndaşlardan", "AR ərazisində və ondan kənarda yaşayan AR vətəndaşlarından", "Yalnız AR ərazisində yaşayanlardan"], correct: 2 },
                    { id: 22, text: "Azərbaycan xalqının suveren hüququ nədən ibarətdir?", options: ["Öz müqəddəratını həll etmək", "Xarici dövlətlərlə birləşmək", "Dövlət rəmzlərini dəyişmək", "Referendum keçirməmək"], correct: 0 },
                    { id: 23, text: "Azərbaycan dövlətinin təməlini nə təşkil edir?", options: ["Ərazi", "Xalqın vahidliyi", "Prezident", "Ordu"], correct: 1 },
                    { id: 24, text: "Azərbaycan dövləti necə respublikadır?", options: ["Demokratik, hüquqi, dünyəvi, unitar", "Sosialist, unitar", "Feodal, dini", "Mütləq monarxiya"], correct: 0 },
                    { id: 25, text: "Azərbaycan Respublikasında dövlət hakimiyyəti daxili məsələlərdə nə ilə məhdudlaşır?", options: ["İradə ilə", "Hüquqla", "Dinlə", "Siyasətlə"], correct: 1 },
                    { id: 26, text: "Azərbaycan Respublikasında dövlət hakimiyyəti necə təşkil olunub?", options: ["Mərkəzləşdirilmiş", "Hakimiyyətlərin bölünməsi prinsipi əsasında", "Yalnız icra hakimiyyəti", "Yalnız məhkəmə hakimiyyəti"], correct: 1 },
                    { id: 27, text: "Azərbaycan Respublikasında icra hakimiyyəti kimə mənsubdur?", options: ["Milli Məclisə", "Prezidentə", "Nazirlər Kabinetinə", "Ali Məhkəməyə"], correct: 1 },
                    { id: 28, text: "Azərbaycan Respublikasının dövlət dili hansıdır?", options: ["İngilis dili", "Rus dili", "Azərbaycan dili", "Türk dili"], correct: 2 },
                    { id: 29, text: "Azərbaycan Respublikasının paytaxtı hansı şəhərdir?", options: ["Gəncə", "Sumqayıt", "Bakı", "Naxçıvan"], correct: 2 },
                    { id: 30, text: "Azərbaycan Respublikasının pul vahidi nədir?", options: ["Dollar", "Avro", "Manat", "Rubl"], correct: 2 },
                    { id: 31, text: "Dövlətin ali məqsədi nədir?", options: ["İqtisadiyyatı inkişaf etdirmək", "İnsan və vətəndaş hüquq və azadlıqlarını təmin etmək", "Ordu qurmaq", "Xarici siyasət yürütmək"], correct: 1 },
                    { id: 32, text: "Referendumla hansı məsələlər həll oluna bilər?", options: ["Vergilər", "Dövlət büdcəsi", "Konstitusiyanın qəbulu və dəyişdirilməsi", "Amnistiya"], correct: 2 },
                    { id: 33, text: "Aşağıdakılardan hansı referendum yolu ilə həll oluna bilməz?", options: ["Konstitusiyanın qəbulu", "Vergilər və dövlət büdcəsi", "Sərhədlərin dəyişdirilməsi", "Xalqın müqəddəratı"], correct: 1 },
                    { id: 34, text: "Azərbaycan xalqını kim təmsil edə bilər?", options: ["Yalnız Prezident", "Yalnız Milli Məclis", "Xalqın seçdiyi səlahiyyetli nümayəndələr", "Bələdiyyələr"], correct: 2 },
                    { id: 35, text: "Hakimiyyətin mənimsənilməsinə yol verilirmi?", options: ["Bəli", "Xeyr, qadağandır", "Yalnız fövqəladə halda", "Müəyyən şərtlərlə"], correct: 1 },
                    { id: 36, text: "Beynəlxalq münasibətlərdə Azərbaycan Respublikası hansı prinsiplərə əsaslanır?", options: ["Yalnız öz maraqlarına", "Hamılıqla qəbul edilmiş beynəlxalq hüquq normalarına", "Yalnız qonşu dövlətlərin maraqlarına", "Hərbi gücə"], correct: 1 },
                    { id: 37, text: "Azərbaycan Respublikası Silahlı Qüvvələrini nə üçün yaradır?", options: ["Hücum etmək üçün", "Təhlükəsizliyini və müdafiəsini təmin etmək üçün", "Digər dövlətləri işğal etmək üçün", "Yalnız parad keçirmək üçün"], correct: 1 },
                    { id: 38, text: "Azərbaycan Respublikasında iqtisadiyyat nəyə əsaslanır?", options: ["Planlı iqtisadiyyata", "Mülkiyyətin müxtəlif növlərinə və bazar münasibətlərinə", "Yalnız dövlət mülkiyyəti", "Yalnız xüsusi mülkiyyət"], correct: 1 },
                    { id: 39, text: "Azərbaycan Respublikasında mülkiyyətin hansı növləri var?", options: ["Yalnız dövlət", "Dövlət, xüsusi və bələdiyyə", "Yalnız xüsusi", "Yalnız bələdiyyə"], correct: 1 },
                    { id: 40, text: "Mülkiyyət hüququ toxunulmazdırmı?", options: ["Xeyr", "Bəli, dövlət tərəfindən müdafiə olunur", "Yalnız dövlət mülkiyyəti toxunulmazdır", "Yalnız xüsusi mülkiyyət toxunulmazdır"], correct: 1 },
                    { id: 41, text: "Sosial inkişaf və dövlət haqqında hansı fikir doğrudur?", options: ["Dövlət xalqın rifahının yüksəldilməsinə çalışır", "Dövlət yalnız varlıları müdafiə edir", "Dövlət sosial məsələlərə qarışmır", "Dövlət yalnız təhsili maliyyələşdirir"], correct: 0 },
                    { id: 42, text: "Ailə, uşaqlar və dövlət haqqında Konstitusiyada nə deyilir?", options: ["Ailə dövlətin xüsusi himayəsindədir", "Uşaqların tərbiyəsi yalnız valideynlərin işidir", "Dövlət ailə məsələlərinə qarışmır", "Ailə yalnız fərdi məsuliyyətdir"], correct: 0 },
                    { id: 43, text: "Mədəniyyət abidələrini qorumaq kimin borcudur?", options: ["Yalnız dövlətin", "Hər bir şəxsin", "Yalnız muzeylərin", "Yalnız tarixçilərin"], correct: 1 },
                    { id: 44, text: "Ətraf mühiti qorumaq kimin borcudur?", options: ["Yalnız ekoloqların", "Hər bir şəxsin", "Yalnız dövlətin", "Heç kimin"], correct: 1 },
                    { id: 45, text: "İnsan və vətəndaş hüquqları nə vaxtdan yaranır?", options: ["Doğulduğu andan", "18 yaşından", "Məktəbə gedəndə", "İşə düzələndə"], correct: 0 },
                    { id: 46, text: "Hər kəsin yaşamaq hüququ varmı?", options: ["Xeyr", "Bəli, toxunulmazdır", "Yalnız vətəndaşların", "Müəyyən yaşdan sonra"], correct: 1 },
                    { id: 47, text: "Azadlıq hüququ nə deməkdir?", options: ["İstədiyi edtmək", "Qanunla qadağan olunmayan hər şeyi etmək", "Heç bir qaydaya tabe olmamaq", "Yalnız evdə oturmaq"], correct: 1 },
                    { id: 48, text: "Mülkiyyət hüququna kim malikdir?", options: ["Yalnız dövlət", "Hər kəs", "Yalnız şirkətlər", "Yalnız kişilər"], correct: 1 },
                    { id: 49, text: "Təhsil hüququ haqqında nə deyilir?", options: ["Təhsil pulludur", "Hər bir vətəndaşın təhsil almaq hüququ vardır", "Təhsil məcburi deyil", "Yalnız ali təhsil pulsuzdur"], correct: 1 },
                    { id: 50, text: "Nikah hüququ neçə yaşdan yaranır?", options: ["16 yaş", "18 yaş (qanunla müəyyən edilmiş hallarda istisna olmaqla)", "20 yaş", "25 yaş"], correct: 1 },
                    { id: 51, text: "Vətəndaşların seçki hüququ neçə yaşdan başlayır?", options: ["16 yaş", "18 yaş", "21 yaş", "25 yaş"], correct: 1 },
                    { id: 52, text: "Vicdan azadlığı nədir?", options: ["İstədiyi dini seçmək və ya heç bir dini seçməmək", "Yalnız bir dinə inanmaq", "Dini qadağan etmək", "Dini icbari etmək"], correct: 0 },
                    { id: 53, text: "Fikir və söz azadlığına təminat verilirmi?", options: ["Xeyr", "Bəli, hər kəsin fikir və söz azadlığı vardır", "Yalnız dövlət məmurlarına", "Yalnız jurnalistlərə"], correct: 1 },
                    { id: 54, text: "Məlumat azadlığı nədir?", options: ["İstədiyi məlumatı yaymaq", "Məlumatı axtarmaq, əldə etmək və yaymaq", "Yalnız gizli məlumatları bilmək", "Məlumatı gizlətmək"], correct: 1 },
                    { id: 55, text: "Yaradıcılıq azadlığına təminat verilirmi?", options: ["Xeyr", "Bəli", "Yalnız rəssamlara", "Yalnız şairlərə"], correct: 1 },
                    { id: 56, text: "Yığıncaqlar azadlığı nədir?", options: ["Hər yerdə yığışmaq", "Dinc, silahsız yığışmaq hüququ", "Yalnız qapalı yerlərdə yığışmaq", "Yalnız dövlət tədbirlərinə getmək"], correct: 1 },
                    { id: 57, text: "Birləşmək hüququ nədir?", options: ["Yalnız ailə qurmaq", "Partiya, həmkarlar ittifaqı və s. yaratmaq hüququ", "Yalnız hərbi birləşmələrə qoşulmaq", "Heç bir qrupa qoşulmamaq"], correct: 1 },
                    { id: 58, text: "Tətil etmək hüququ varmı?", options: ["Xeyr", "Bəli, hər kəsin tətil etmək hüququ vardır", "Yalnız polisə", "Yalnız hərbçilərə"], correct: 1 },
                    { id: 59, text: "Sosial təminat hüququ kimlərə aiddir?", options: ["Yalnız uşaqlara", "Yaşa, xəstəliyə, əlilliyə görə hər kəsə", "Yalnız işləyənlərə", "Heç kimə"], correct: 1 },
                    { id: 60, text: "Təhlükəsiz yaşamaq hüququ varmı?", options: ["Xeyr", "Bəli", "Yalnız kənddə", "Yalnız şəhərdə"], correct: 1 },
                    { id: 61, text: "Mənzil toxunulmazlığı nədir?", options: ["Evə icazəsiz girmək olar", "Heç kim mənzilə qanunsuz girə bilməz", "Mənzil hər kəsə açıqdır", "Mənzil yalnız dövlətindir"], correct: 1 },
                    { id: 62, text: "Şəxsi toxunulmazlıq hüququ nədir?", options: ["İstənilən şəxsi saxlamaq olar", "Hər kəsin şəxsi toxunulmazlıq hüququ vardır", "Yalnız deputatlar toxunulmazdır", "Şəxsi məlumatları yaymaq olar"], correct: 1 },
                    { id: 63, text: "Hüquqi yardım almaq hüququ varmı?", options: ["Xeyr", "Bəli, hər bir şəxsin hüququdur", "Yalnız varlılara", "Yalnız günahsızlara"], correct: 1 },
                    { id: 64, text: "Təqsirsizlik prezumpsiyası nədir?", options: ["Hər kəs günahkardır", "Təqsiri sübut olunana qədər hər kəs təqsirsiz sayılır", "Məhkəməsiz cəza vermək olar", "Polis hər kəsi cəzalandıra bilər"], correct: 1 },
                    { id: 65, text: "Bir cinayətə görə iki dəfə məhkum etmək olarmı?", options: ["Bəli", "Xeyr", "Yalnız ağır cinayətdə", "Hakimin qərarı ilə"], correct: 1 },
                    { id: 66, text: "Məhkəməyə müraciət etmək hüququ varmı?", options: ["Xeyr", "Bəli, hər kəsin hüququdur", "Yalnız vəkillərə", "Yalnız şikayətçilərə"], correct: 1 },
                    { id: 67, text: "Vətəndaşlıq hüququ nədir?", options: ["İstədiyi ölkəyə getmək", "Şəxsin dövlətlə sabit hüquqi əlaqəsi", "Yalnız pasport almaq", "Heç bir öhdəlik daşımamaq"], correct: 1 },
                    { id: 68, text: "Vətəndaşın əsas vəzifələri hansılardır?", options: ["Yalnız vergi vermək", "Konstitusiyaya riayət etmək, vergi vermək, vətəni müdafiə etmək", "Yalnız işləmək", "Heç bir vəzifəsi yoxdur"], correct: 1 },
                    { id: 69, text: "Vergi vermək hər kəsin borcudumu?", options: ["Xeyr", "Bəli, qanunla müəyyən edilmiş vergiləri ödəmək hər kəsin borcudur", "Yalnız şirkətlərin", "Yalnız məmurların"], correct: 1 },
                    { id: 70, text: "Vətəni müdafiə etmək kimin borcudur?", options: ["Yalnız əsgərlərin", "Hər bir vətəndaşın", "Yalnız könüllülərin", "Heç kimin"], correct: 1 },
                    { id: 71, text: "Dövlət rəmzlərinə hörmət etmək borcudumu?", options: ["Xeyr", "Bəli", "Yalnız məktəblilərin", "Yalnız idmançıların"], correct: 1 },
                    { id: 72, text: "Qanunsuz sərəncamlara tabe olmamaq hüququ varmı?", options: ["Xeyr", "Bəli", "Yalnız hərbçilərə", "Yalnız polislərə"], correct: 1 },
                    { id: 73, text: "Milli Məclisin deputatı neçə il müddətinə seçilir?", options: ["4 il", "5 il", "6 il", "7 il"], correct: 1 },
                    { id: 74, text: "Milli Məclisə seçkilər nə vaxt keçirilir?", options: ["Hər il", "Hər 5 ildən bir", "Hər 10 ildən bir", "İstənilən vaxt"], correct: 1 },
                    { id: 75, text: "Kimlər deputat seçilə bilməz?", options: ["Müəllimlər", "Hərbçilər, hakimlər, dövlət məmurları (vəzifəsindən istefa vermədən)", "Həkimlər", "Tələbələr"], correct: 1 },
                    { id: 76, text: "Milli Məclisin sessiyaları nə vaxt olur?", options: ["Yalnız yayda", "Yaz və payız sessiyaları", "Hər ay", "Yalnız qışda"], correct: 1 },
                    { id: 77, text: "Milli Məclis hansı aktları qəbul edir?", options: ["Fərman və sərəncamlar", "Qanunlar və qərarlar", "Yalnız qərarlar", "Yalnız təlimatlar"], correct: 1 },
                    { id: 78, text: "Qanunvericilik təşəbbüsü hüququna kim malikdir?", options: ["Prezident, deputatlar, Ali Məhkəmə, Prokurorluq, NMR Ali Məclisi", "Yalnız Prezident", "Yalnız deputatlar", "Hər bir vətəndaş"], correct: 0 },
                    { id: 79, text: "Prezident neçə il müddətinə seçilir?", options: ["5 il", "7 il", "10 il", "4 il"], correct: 1 },
                    { id: 80, text: "Prezident seçilmək üçün yaş həddi varmı?", options: ["Xeyr, yalnız seçki hüququna malik olmalıdır", "Bəli, 35 yaş", "Bəli, 40 yaş", "Bəli, 25 yaş"], correct: 0 },
                    { id: 81, text: "Prezidentin andiçmə mərasimi nə vaxt keçirilir?", options: ["Seçkidən 1 ay sonra", "Seçkilərin nəticələri elan olunduqdan sonra 3 gün ərzində", "Həmin gün", "10 gün sonra"], correct: 1 },
                    { id: 82, text: "Prezident hansı aktları qəbul edir?", options: ["Qanunlar", "Fərman və sərəncamlar", "Qərarlar", "Təlimatlar"], correct: 1 },
                    { id: 83, text: "Nazirlər Kabineti kimə tabedir?", options: ["Milli Məclisə", "Prezidentə", "Ali Məhkəməyə", "Xalqa"], correct: 1 },
                    { id: 84, text: "Baş naziri kim təyin edir?", options: ["Milli Məclis", "Prezident (Milli Məclisin razılığı ilə)", "Xalq", "Məhkəmə"], correct: 1 },
                    { id: 85, text: "Məhkəmə hakimiyyəti kimlər tərəfindən həyata keçirilir?", options: ["Məhkəmələr", "Polis", "Prokurorluq", "İcra hakimiyyəti"], correct: 0 },
                    { id: 86, text: "Konstitusiya Məhkəməsinin hakimlərini kim təyin edir?", options: ["Prezident", "Milli Məclis (Prezidentin təqdimatı ilə)", "Ali Məhkəmə", "Xalq"], correct: 1 },
                    { id: 87, text: "Ali Məhkəmə nəyə nəzarət edir?", options: ["Vergilərə", "Ümumi və ixtisaslaşdırılmış məhkəmələrin fəaliyyətinə", "Prezidentə", "Milli Məclisə"], correct: 1 },
                    { id: 88, text: "Apellyasiya məhkəmələri nədir?", options: ["Birinci instansiya məhkəməsi", "Yuxarı instansiya məhkəməsi", "Yalnız hərbi məhkəmə", "Yalnız iqtisadi məhkəmə"], correct: 1 },
                    { id: 89, text: "Prokurorluq nədir?", options: ["Məhkəmə orqanı", "Vahid mərkəzləşdirilmiş orqan", "İcra orqanı", "Bələdiyyə orqanı"], correct: 1 },
                    { id: 90, text: "Naxçıvan Muxtar Respublikasının statusu nədir?", options: ["Müstəqil dövlət", "AR tərkibində muxtar dövlət", "Federasiya", "Vilayət"], correct: 1 },
                    { id: 91, text: "NMR-in qanunvericilik orqanı hansıdır?", options: ["Milli Məclis", "Ali Məclis", "Nazirlər Kabineti", "Dövlət Şurası"], correct: 1 },
                    { id: 92, text: "Bələdiyyələr nədir?", options: ["Dövlət hakimiyyəti orqanı", "Yerli özünüidarəetmə orqanı", "Xüsusi xidmət orqanı", "Siyasi partiya"], correct: 1 },
                    { id: 93, text: "Bələdiyyə üzvləri necə seçilir?", options: ["Təyin olunur", "Seçkilər yolu ilə", "Püşkatma ilə", "Prezident tərəfindən"], correct: 1 },
                    { id: 94, text: "Konstitusiyaya dəyişikliklər necə edilir?", options: ["Yalnız referendumla", "Referendum və ya Konstitusiya qanunları ilə", "Yalnız Prezident fərmanı ilə", "Yalnız Milli Məclis qərarı ilə"], correct: 1 },
                    { id: 95, text: "Konstitusiyanın qəbulu günü nə vaxtdır?", options: ["18 oktyabr", "12 noyabr", "28 may", "15 iyun"], correct: 1 },
                    { id: 96, text: "Dövlət bayrağı neçə rənglidir?", options: ["2", "3", "4", "5"], correct: 1 },
                    { id: 97, text: "Dövlət bayrağındakı göy rəng nəyi ifadə edir?", options: ["İslamı", "Türk mənşəyini", "Müasirliyi", "Azadlığı"], correct: 1 },
                    { id: 98, text: "Dövlət bayrağındakı qırmızı rəng nəyi ifadə edir?", options: ["Türk mənşəyini", "Müasirliyi və demokratiyanı", "İslamı", "Qanı"], correct: 1 },
                    { id: 99, text: "Dövlət bayrağındakı yaşıl rəng nəyi ifadə edir?", options: ["Təbiəti", "İslam sivilizasiyasını", "Gəncliyi", "Sülhü"], correct: 1 },
                    { id: 100, text: "Dövlət gerbinin mərkəzində nə təsvir olunub?", options: ["Aypara", "Səkkizguşəli ulduz və alov", "Qılınc", "Palıd budağı"], correct: 1 },
                    { id: 101, text: "Dövlət himninin mətni kimə məxsusdur?", options: ["Üzeyir Hacıbəyli", "Əhməd Cavad", "Səməd Vurğun", "Bəxtiyar Vahabzadə"], correct: 1 },
                    { id: 102, text: "Dövlət himninin musiqisi kimə məxsusdur?", options: ["Fikrət Əmirov", "Üzeyir Hacıbəyli", "Qara Qarayev", "Müslüm Maqomayev"], correct: 1 },
                    { id: 103, text: "Dövlət dili haqqında qanunları kim qəbul edir?", options: ["Prezident", "Milli Məclis", "Nazirlər Kabineti", "Dilçilik İnstitutu"], correct: 1 },
                    { id: 104, text: "Xalqın vahidliyi nəyi təşkil edir?", options: ["Dövlətin gücünü", "Azərbaycan dövlətinin təməlini", "İqtisadiyyatı", "Siyasəti"], correct: 1 },
                    { id: 105, text: "Azərbaycan Respublikasının ərazisi haqqında nə deyilir?", options: ["Vahiddir, toxunulmazdır və bölünməzdir", "Parçalana bilər", "Yalnız qurudan ibarətdir", "Dəyişdirilə bilməz"], correct: 0 },
                    { id: 106, text: "Məhkəmə qərarları kimin adından çıxarılır?", options: ["Hakimin", "Dövlətin", "Xalqın", "Prezidentin"], correct: 1 },
                    { id: 107, text: "Hakimlər müstəqildirmi?", options: ["Xeyr", "Bəli, yalnız qanuna tabedirlər", "Yalnız Baş prokurora tabedirlər", "Prezidentə tabedirlər"], correct: 1 },
                    { id: 108, text: "Məhkəmə icraatı hansı dildə aparılır?", options: ["Rus", "Azərbaycan", "İngilis", "Türk"], correct: 1 },
                    { id: 109, text: "Hər kəsin bərabərlik hüququ varmı?", options: ["Xeyr", "Bəli, qanun və məhkəmə qarşısında hər kəs bərabərdir", "Yalnız vətəndaşlar bərabərdir", "Yalnız kişilər bərabərdir"], correct: 1 },
                    { id: 110, text: "İnsan ləyaqəti qorunurmu?", options: ["Xeyr", "Bəli, dövlət tərəfindən qorunur", "Yalnız məmurların ləyaqəti", "Yalnız hörmətli şəxslərin"], correct: 1 },
                    { id: 111, text: "İşgəncə və əzab vermək olarmı?", options: ["Bəli", "Xeyr, qəti qadağandır", "Yalnız cinayətkarlara", "Müstəntiqin icazəsi ilə"], correct: 1 },
                    { id: 112, text: "Məcburi əmək varmı?", options: ["Bəli", "Xeyr, qadağandır (qanunla nəzərdə tululmuş hallar istisna olmaqla)", "Yalnız kənddə", "Yalnız zavodda"], correct: 1 },
                    { id: 113, text: "İstirahət hüququ varmı?", options: ["Xeyr", "Bəli, hər kəsin istirahət hüququ vardır", "Yalnız tələbələrə", "Yalnız uşaqlara"], correct: 1 },
                    { id: 114, text: "Təhlükəsizlik və sağlam ətraf mühitdə yaşamaq hüququ varmı?", options: ["Xeyr", "Bəli", "Yalnız varlılara", "Yalnız şəhər sakinlərinə"], correct: 1 },
                    { id: 115, text: "Hüquq və azadlıqların müdafiəsinə təminat verilirmi?", options: ["Xeyr", "Bəli, dövlət tərəfindən təminat verilir", "Yalnız bəzi hallarda", "Yalnız məhkəmədə"], correct: 1 },
                    { id: 116, text: "Ombudsman (İnsan hüquqları üzrə müvəkkil) nə ilə məşğul olur?", options: ["Cinayət axtarışı ilə", "İnsan hüquq və azadlıqlarının bərpası ilə", "Vergi yığımı ilə", "Yol hərəkəti ilə"], correct: 1 },
                    { id: 117, text: "Seçki sisteminin əsas prinsipləri hansılardır?", options: ["Gizli səsvermə", "Ümumi, bərabər, birbaşa seçki hüququ, sərbəst, şəxsi və gizli səsvermə", "Açıq səsvermə", "Təyinat"], correct: 1 },
                    { id: 118, text: "Vətəndaşlıqdan məhrum etmək olarmı?", options: ["Bəli", "Xeyr, Azərbaycan Respublikasının vətəndaşı heç bir halda vətəndaşlıqdan məhrum edilə bilməz", "Yalnız xaricdə yaşayanları", "Yalnız cinayət törədənləri"], correct: 1 },
                    { id: 119, text: "Dövlət dilinin statusu neçənci maddədir?", options: ["10", "21", "30", "45"], correct: 1 },
                    { id: 120, text: "Konstitusiyanın aliliyi nə deməkdir?", options: ["Bütün qanunlar ona uyğun olmalıdır", "O yalnız bir kitabdır", "Onu dəyişmək asandır", "Ona əməl etmək məcburi deyil"], correct: 0 }
                ]
            }
        ];
